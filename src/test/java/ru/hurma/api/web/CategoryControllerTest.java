...
class CategoryControllerTest {
    ...
    void getCategories() throws Exception {
        ...
        mockMvc.perform(get("/ajax/categories"))
                ...
                .andExpect(jsonPath("$[0].items[0].bought", is(apple.isBought())))
                ...
                .andExpect(jsonPath("$[0].items[1].bought", is(lemon.isBought())))
                ...
                .andExpect(jsonPath("$[1].items[0].bought", is(tomato.isBought())))
